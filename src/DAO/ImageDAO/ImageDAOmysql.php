...
class ImageDAOmysql extends AbstractDAO implements ImageDAOInterface
{
	...
	public function saveAll(array $images, int $itemId): array
	{
		try
		{
			...
			$insertOriginal = $this->getInsertPrepareStatement('up_original_image', ['PATH', 'ITEM_ID', 'IS_MAIN'], count($images));
			$insertOriginalArray = [];
			...
			$insertSize = $this->getInsertPrepareStatement('up_image_with_size', ['ORIGINAL_IMAGE_ID', 'PATH', 'SIZE'], $countInsertSize);
