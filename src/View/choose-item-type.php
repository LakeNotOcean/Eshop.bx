...
<div class="container">
	<form action="<?= URLResolver::resolve('add-item') ?>" method="get" enctype="multipart/form-data" class="form-add">
		<label for="item-type" class="field">
			...
			<a href="<?= URLResolver::resolve('add-item-type') ?>" class="btn btn-normal">Добавить тип</a>
		</label>
