...
INSERT INTO `up_item`
VALUES (2, 'Asus GTX 750', 7499,
        'Видеокарта Asus GeForce GTX 750 позволяет расширить рабочие и игровые возможности Вашего ПК.',
        'Видеокарта Asus GeForce GTX 750 позволяет расширить рабочие и игровые возможности Вашего ПК. Производительности устройства достаточно для воспроизведения видео в формате Full HD и для установки наивысших настроек в играх. Процессор с рабочей тактовой частотой 1060 МГц может быть разогнан на 7%, если потребуется больше ресурсов. Два гигабайта памяти эффективно расходуются при многопоточной нагрузке, а разрядность шины в 128 бит позволяет ускорить обмен данными между памятью и GPU.\n\nAsus GeForce GTX 750 оснащен охладительной системой с одним большим вентилятором, который отводит тепло от микрочипов, продлевая срок эксплуатации карты. Потребление энергии адаптером в моменты пиковой нагрузки не превышает 75 Вт. Поэтому подключение дополнительного питания от БП не требуется.',
        NULL, 1, '2022-02-02 17:36:04', '2022-02-02 17:36:11');
UNLOCK TABLES;
...
INSERT INTO `up_specs`
VALUES (2, 'Asus', 'Китай', '36 мес.', 2012, '2 ГБ', 'GDDR5', '192 бит', '28 нм', '1059 МГц', '5010 МГц', '2560х1600',
        'HDMI, VGA (D-Sub), DVI-D', 'PCI-E', 'нет', '55 Вт', 1, 185, 28);
UNLOCK TABLES;
